#!/usr/bin/env bash
# CachyOS + Niri: cursor Vision-Black + tema WhiteSur-Dark + ícones WhiteSur
# Linka os configs de niri/, waybar/, rofi/, dunst/, swaylock/ e kitty/ para ~/.config/
# Rode: bash cachyos-niri/scripts/niri-complete.sh
...
echo "=============================================="
echo "  Niri: Cursor + GTK + Ícones + Configs"
echo "=============================================="
echo ""
...
# --- 4. GTK via arquivo + variáveis de sessão ---
echo ""
...
# --- 5. LINKAR CONFIGS → ~/.config/ ---
echo ">>> 5. Linkando configs (niri, kitty, waybar, rofi, dunst, swaylock)"
echo ""
...
echo "  Wallpaper: edite config.kdl → spawn-at-startup swaybg"
echo ""
